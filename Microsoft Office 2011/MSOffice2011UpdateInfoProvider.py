...
# Modified by Tyler Riti to change the version variable to the version of the
# downloaded update.
...
class MSOffice2011UpdateInfoProvider(Processor):
    ...
    output_variables = {
        ...
        "version": {
            "description": "Update version number (if not already provided).",
        },
        "additional_pkginfo": {
            "description":
    ...
    def get_mso2011update_info(self):
        ...
        if version_str == "latest":
            ...
            # Update the version variable with the actual update version.
